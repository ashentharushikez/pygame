...
image_filenames = ['Black_viper.png', 'truck.png', 'taxi.png', 'Audi.png', 'Mini_van.png']
vehicle_images = []
...
while running:
    ...
    for event in pygame.event.get():
        ...
        if event.type == KEYDOWN:
            ...
            # chech if there's a side swipe collision after changing lanes
            for vehicle in vehicle_group:
                if pygame.sprite.collide_rect(player, vehicle):

                    gameover = True

                    # place the player's car next to another vehicle
